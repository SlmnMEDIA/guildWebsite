...
;(function($){
	...
	$.wowTalents.defaultOptions = {
		defaultNeed     : 'None',     // Default need that is set when no setting is found
	...
	$.wowTalents.talents = {"root": [{
		...
		"color" : "#abd473",
		"tree"  : [[ "Beast Mastery", "icon_hunter_beast_mastery" ],    comment out sections like this when you are not recruiting the class to hide it
